...
- (NSString *)_sendRequestWithMethodWithImage:(NSString *)method 
                                         path:(NSString *)path 
                                  requestType:(MGTwitterRequestType)requestType 
                                 responseType:(MGTwitterResponseType)responseType;
// Parsing methods
                                 ...
                                 responseType:(MGTwitterResponseType)responseType
{
    ...
    NSString * domain = @"upload.twitter.com";
    NSString *connectionType = @"https";
    NSString *urlString = [NSString stringWithFormat:@"%@://%@/%@", 
                           connectionType,
                           domain, fullPath];
    ...
    if (isPOST) {
        ...
        NSData *statusData = [@"안녕!!" dataUsingEncoding:NSUTF8StringEncoding];
        ...
        NSString *finalBody = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
...
{
    NSString *path = @"1/statuses/update_with_media.json";
...
//    }
    ...
    [self _sendRequestWithMethodWithImage:HTTP_POST_METHOD 
                                     path:path 
                                    requestType:MGTwitterUpdateSendRequest
                                    responseType:MGTwitterStatus];
